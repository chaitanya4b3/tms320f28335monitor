...
------------------------------------------------------------------*/
   ...
   flash_Status = Flash_Erase((SECTORB|SECTORC),&FlashStatus);
   if(flash_Status != STATUS_SUCCESS) 
   {
       Example_Error(flash_Status);
   } 
...
// then nothing is done and an error is returned. 
    ...
    Length = 0x400;
    flash_Status = Flash_Program(Flash_ptr,Buffer,Length,&FlashStatus);
    if(flash_Status != STATUS_SUCCESS) 
    {
        Example_Error(flash_Status);
    }
    ...
    flash_Status = Flash_Verify(Flash_ptr,Buffer,Length,&FlashStatus);
    if(flash_Status != STATUS_SUCCESS) 
    {
        Example_Error(flash_Status);
    }            
...
// program another bit in the same memory location. 
   ...
   i = 0xFFFE;
   Length = 1;
   flash_Status = Flash_Program(Flash_ptr,&i,Length,&FlashStatus);
   if(flash_Status != STATUS_SUCCESS) 
   {
       Example_Error(flash_Status);
   }
   ...
   if(flash_Status != STATUS_SUCCESS) 
   {
    ...
    i = 0xFFFE;    
    flash_Status = Flash_Verify(Flash_ptr,&i,Length,&FlashStatus);
    if(flash_Status != STATUS_FAIL_VERIFY) 
    {
        Example_Error(flash_Status);
    } 
...
// been programmed to 0.
   ...
   if(flash_Status != STATUS_FAIL_ZERO_BIT_ERROR) 
   {
       Example_Error(flash_Status);
   }
...
// --------------   
   ...
   if(flash_Status != STATUS_FAIL_ADDR_INVALID) 
   {
       Example_Error(flash_Status);
   }
...
------------------------------------------------------------------*/
   ...
   flash_Status = Flash_Erase(SECTORB,&FlashStatus);
   if(flash_Status != STATUS_SUCCESS) 
   {
       Example_Error(flash_Status);
   }
   ...
   flash_Status = Flash_Erase((SECTORC),&FlashStatus);
   if(flash_Status != STATUS_SUCCESS) 
   {
       Example_Error(flash_Status);
   }
   ...
   flash_Status = Flash_Erase(0,&FlashStatus);
   // Should return STATUS_FAIL_NO_SECTOR_SPECIFIED
   if(flash_Status != STATUS_FAIL_NO_SECTOR_SPECIFIED) 
   {
       Example_Error(flash_Status);
   }
...
void Example_Error(Uint16 flash_Status)
{
